...
model = RobertaModel.from_pretrained('/root/cxt/construct_graph_20241125/RoBert_model/roberta-base/')
...
np.save('/root/cxt/construct_graph_20241125/dataset/302dim_RoBERTa.npy', combined_df)